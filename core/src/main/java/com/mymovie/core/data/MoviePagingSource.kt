...
class MoviePagingSource(private val remoteDataSource: RemoteDataSource, private val genres: String?): PagingSource<Int, Movie>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Movie> {
        try {
            ...
            val responseData = remoteDataSource.getMovie(genres, page).first()
